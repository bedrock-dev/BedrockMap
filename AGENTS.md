...
> This file is read automatically by both GitHub Copilot and OpenAI Codex.
> The `tools` frontmatter above is Copilot-specific; Codex ignores it and uses
> the body below. Keep the instructions tool-agnostic.
...
- When modifying a file, also convert any pre-existing Chinese comments in the
  touched code to English.
